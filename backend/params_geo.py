"""
Geographic adjustment: zip -> state; regional variation in treatment adoption and cost.
Provenance: CMS regional variability (e.g. IPPS wage index, regional utilization). No fabricated modifiers.
"""

from typing import Dict, Optional
from provenance import Provenance

# Zip prefix / state mapping (simplified; full table from free Census or USPS data).
# Source: Public domain. https://www.census.gov/library/reference/code-lists/zip.html
# Assumption: We use first 3 digits of zip for region. Documented.
ZIP3_TO_STATE: Dict[str, str] = {
    "006": "PR", "007": "PR", "008": "VI",
    ...
    "550": "MN", "551": "MN", "553": "MN", "554": "MN", "555": "MN", "556": "MN", "557": "MN", "558": "MN", "559": "MN", "560": "MN", "561": "MN", "562": "MN", "563": "MN", "564": "MN", "565": "MN", "566": "MN", "567": "MN", "568": "MN",
    ...
    "640": "MO", "641": "MO", "642": "MO", "644": "MO", "645": "MO", "646": "MO", "647": "MO", "648": "MO", "649": "MO",
    ...
    "680": "NE", "681": "NE", "683": "NE", "684": "NE", "685": "NE", "686": "NE", "687": "NE", "688": "NE", "689": "NE", "690": "NE", "691": "NE", "692": "NE", "693": "NE", "694": "NE", "695": "NE", "696": "NE", "697": "NE", "698": "NE",
    "700": "LA", "701": "LA", "703": "LA", "704": "LA", "705": "LA", "706": "LA", "707": "LA", "708": "LA", "709": "LA", "710": "LA", "711": "LA", "712": "LA", "713": "LA", "714": "LA", "715": "LA", "716": "LA", "717": "LA", "718": "LA", "719": "LA", "720": "LA", "721": "LA", "722": "LA", "723": "LA", "724": "LA", "725": "LA", "726": "LA", "727": "LA", "728": "LA", "729": "LA",     "730": "LA", "731": "LA", "732": "LA", "733": "LA", "734": "LA", "735": "LA", "736": "LA", "737": "LA", "738": "LA", "739": "LA",
    ...
    "890": "NV", "891": "NV", "893": "NV", "894": "NV", "895": "NV", "897": "NV", "898": "NV", "899": "NV",
...
# Default for unmapped zip3
DEFAULT_STATE = "US"

# CMS regional cost modifier (state or region). Source: CMS wage index / regional variation.
# Documented: CMS IPPS wage index by CBSA/state. Assumption: 1.0 = national average; ±15% range.
# Only use documented values; here we use 1.0 for all (no fabricated variation until we plug CMS table).
REGIONAL_COST_MODIFIER: Dict[str, float] = {}  # state -> modifier; empty => 1.0 everywhere
PROVENANCE_GEO = Provenance(
    source="Census/CMS",
    citation="Zip-to-state: Census ZIP code list. Regional cost: CMS IPPS wage index (data.cms.gov). Assumption: modifier 1.0 until CMS table loaded.",
    note="No fabricated geographic modifiers.",
)


def zip_to_state(zip_code: str) -> str:
    zip_clean = "".join(c for c in zip_code if c.isdigit())[:5]
    if len(zip_clean) < 3:
        return DEFAULT_STATE
    zip3 = zip_clean[:3]
    return ZIP3_TO_STATE.get(zip3, DEFAULT_STATE)


def get_regional_cost_modifier(zip_code: str) -> float:
    state = zip_to_state(zip_code)
    return REGIONAL_COST_MODIFIER.get(state, 1.0)
